...
const PRIORITY_BY_TICKET_TYPE: Record<"academic" | "technical" | "administrative" | "other", "0" | "1" | "2" | "3"> = {
  academic: "3",
  administrative: "2",
  other: "1",
  technical: "0",
...
export function SubmitSupportForm({ onSuccess }: SubmitSupportFormProps) {
  ...
  const [ticketType, setTicketType] = useState<"academic" | "technical" | "administrative" | "other">("academic");
  const [description, setDescription] = useState("");
  const priority = PRIORITY_BY_TICKET_TYPE[ticketType];
  ...
  }, [subject, ticketType, description, onSuccess]);
      ...
      <form onSubmit={handleSubmit} className={styles.formCard}>
        ...
        <div className={styles.formFields}>
          <Select
            ...
            options={TICKET_TYPES as unknown as SelectOption[]}
            disabled={submitting}
          />
